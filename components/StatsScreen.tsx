      ...
      <div className="bg-gradient-to-br from-purple-600 to-purple-700 p-6 rounded-3xl text-white shadow-xl">
        ...
        <div className="mb-4">
          <div className="flex items-center justify-between mb-2">
            <span className="text-purple-100 text-sm">Current Points</span>
            <span className="text-2xl font-bold">{userPoints}</span>
          </div>
          
          <div className="flex items-center justify-between mb-3">
            <span className="text-purple-100 text-sm">Target</span>
            <span className="text-lg font-semibold">{rewardConfig.targetPoints} pts</span>
          </div>
          
          {/* Progress Bar */}
          <div className="w-full bg-purple-800 rounded-full h-3 mb-2">
            <div 
