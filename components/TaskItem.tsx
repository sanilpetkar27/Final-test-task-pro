...
const TaskItem: React.FC<TaskItemProps> = ({ task, employees, onClick }) => {
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className="w-full text-left bg-white rounded-2xl border border-slate-200 shadow-sm px-5 py-4 active:scale-[0.98] transition-all duration-150 hover:shadow-md focus:outline-none focus:ring-2 focus:ring-indigo-100"
    >
