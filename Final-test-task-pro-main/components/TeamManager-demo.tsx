...
import { UserPlus, UserMinus, User, ShieldCheck, Phone, Wifi } from 'lucide-react';
      ...
      <div className="bg-white rounded-2xl p-4 shadow-sm border border-slate-200">
        ...
        <div className="grid grid-cols-3 gap-3 mb-4">
          ...
          <div className="bg-purple-50 rounded-xl p-3 text-center">
            <div className="text-2xl font-bold text-purple-600">{managerEmployees.length}</div>
            <div className="text-xs text-purple-700 font-medium">Managers</div>
          </div>
        </div>
